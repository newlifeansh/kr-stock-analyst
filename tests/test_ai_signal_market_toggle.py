...
def test_unified_roots_use_compact_community_market_toggle_contract():
    ...
    assert 'src="/dashboard-app-v170.js?v=20260915v543"' in shell.text
    assert 'src="/assets/staging/toss-ia.js?v=20260915-recommendation-data-details-v113"' in shell.text
