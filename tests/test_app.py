...
def test_dashboard_v3_uses_four_primary_views_and_nested_market_tabs():
    ...
    assert 'styles.css?v=20260728v104' in shell
    assert 'app.js?v=20260728v104' in shell
    assert 'DASHBOARD_SW_VERSION = "20260728v104"' in client.get("/dashboard-sw.js").text
