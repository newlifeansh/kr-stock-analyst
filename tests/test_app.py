...
def test_dashboard_v3_uses_four_primary_views_and_nested_market_tabs():
    ...
    assert 'Home market briefing 7.1: Naver-style flat sections without card containers.' in styles
    assert 'styles.css?v=20260728v110' in shell
    assert 'app.js?v=20260728v110' in shell
    assert 'DASHBOARD_SW_VERSION = "20260728v110"' in client.get("/dashboard-sw.js").text
