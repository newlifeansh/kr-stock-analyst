...
def test_dashboard_v3_uses_four_primary_views_and_nested_market_tabs():
    ...
    assert 'return ["KOSPI", "KOSDAQ", "NASDAQ", "SP500", "GOLD", "OIL"];' in source
    assert 'return ["NASDAQ", "SP500", "KOSPI", "KOSDAQ", "GOLD", "OIL"];' in source
    ...
    assert 'styles.css?v=20260730v137' in shell
    assert '__DASHBOARD_ASSET_VERSION__' not in shell
    ...
    assert 'app.js?v=20260730v137' in shell
    ...
    assert 'DASHBOARD_SW_VERSION = "20260730v137"' in client.get("/dashboard-sw.js").text
