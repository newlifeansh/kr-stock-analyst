const DASHBOARD_SW_VERSION = "20260730v136";
const DASHBOARD_BUILD_VERSION = "20260729v134";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/dashboard?view=home",
  "/assets/dashboard/styles.css?v=20260730v136",
  "/assets/dashboard/app.js?v=20260730v136",
