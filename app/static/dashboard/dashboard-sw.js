const DASHBOARD_SW_VERSION = "20260914v539";
const DASHBOARD_BUILD_VERSION = "20260914v539";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260914v539&build=20260914v539",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260914-us-signal-integrity-v110",
  "/assets/staging/stock-change-copy-logic.js?v=20260914-us-signal-integrity-v110",
  "/assets/staging/toss-ia.js?v=20260914-us-signal-integrity-v110",
