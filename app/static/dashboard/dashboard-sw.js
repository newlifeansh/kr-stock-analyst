const DASHBOARD_SW_VERSION = "20260906v474";
const DASHBOARD_BUILD_VERSION = "20260906v474";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260906v474&build=20260906v474",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260906-us-parity-v98",
  "/assets/staging/stock-change-copy-logic.js?v=20260906-us-parity-v98",
  "/assets/staging/toss-ia.js?v=20260906-us-parity-v98",
