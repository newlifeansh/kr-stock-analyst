const DASHBOARD_SW_VERSION = "20260921v550";
const DASHBOARD_BUILD_VERSION = "20260921v550";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260921v550&build=20260921v550",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260921-domestic-market-v115",
  "/assets/staging/stock-change-copy-logic.js?v=20260921-domestic-market-v115",
  "/assets/staging/toss-ia.js?v=20260921-domestic-market-v115",
