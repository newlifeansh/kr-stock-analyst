const DASHBOARD_SW_VERSION = "20260902v461";
const DASHBOARD_BUILD_VERSION = "20260902v461";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260902v461&build=20260902v461",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260902-signal-sell-labels-v91",
  "/assets/staging/stock-change-copy-logic.js?v=20260902-signal-sell-labels-v91",
  "/assets/staging/toss-ia.js?v=20260902-signal-sell-labels-v91",
