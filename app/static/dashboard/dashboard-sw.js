  ...
  event.waitUntil(
    caches
      ...
      .then((clients) => Promise.all(clients.map((client) => {
        ...
        if (currentBuild === DASHBOARD_BUILD_VERSION) {
          return undefined;
        }
