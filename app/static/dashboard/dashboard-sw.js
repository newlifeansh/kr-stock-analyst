const DASHBOARD_SW_VERSION = "20260907v478";
const DASHBOARD_BUILD_VERSION = "20260907v478";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260907v478&build=20260907v478",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260906-us-parity-v100",
  "/assets/staging/stock-change-copy-logic.js?v=20260906-us-parity-v100",
  "/assets/staging/toss-ia.js?v=20260906-us-parity-v100",
