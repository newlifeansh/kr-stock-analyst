const DASHBOARD_SW_VERSION = "20260925v554";
const DASHBOARD_BUILD_VERSION = "20260925v554";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260925v554&build=20260925v554",
  ...
  "/assets/staging/toss-ia.js?v=20260925-us-fold-chart-v118",
