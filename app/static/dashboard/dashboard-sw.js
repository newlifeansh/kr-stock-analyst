const DASHBOARD_SW_VERSION = "20260914v537";
const DASHBOARD_BUILD_VERSION = "20260914v537";
const STATIC_CACHE = `secret-note-static-${DASHBOARD_SW_VERSION}-${DASHBOARD_BUILD_VERSION}`;
const STATIC_ASSETS = [
  "/assets/dashboard/styles.css?v=20260914v537&build=20260914v537",
  ...
  "/assets/staging/ai-stock-response-logic.js?v=20260910-watchlist-reference-v109",
  "/assets/staging/stock-change-copy-logic.js?v=20260910-watchlist-reference-v109",
  "/assets/staging/toss-ia.js?v=20260910-watchlist-reference-v109",
