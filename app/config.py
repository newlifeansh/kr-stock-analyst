...
class Settings(BaseSettings):
    ...
    briefing_retention_snapshots: int = 288
    ...
    stock_news_snapshot_refresh_hours: int = 6
    stock_news_snapshot_max_workers: int = 8
    stock_company_snapshot_enabled: bool = True
    stock_company_snapshot_poll_seconds: int = 86400
    stock_company_snapshot_refresh_days: int = 30
    stock_company_snapshot_max_workers: int = 8
    x_feed_enabled: bool = True
    x_bearer_token: Optional[str] = None
    x_feed_cache_seconds: int = 300
