...
def _repair_completed_daily_close_from_intraday(
    ...
    *,
    ...
    for index, timestamp in enumerate(intraday.get("timestamp") or []):
        ...
        high = _to_decimal(_list_get(intraday_quote.get("high") or [], index))
        low = _to_decimal(_list_get(intraday_quote.get("low") or [], index))
        close = _to_decimal(
...
def build_us_recommendations(
    ...
    *,
    ...
    return {
        ...
        "ranking_as_of": canonical.get("ranking_as_of"),
        ...
        "refresh_mode": canonical.get("refresh_mode", "collector_owned"),
